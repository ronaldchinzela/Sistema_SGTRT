<?php
    ...
    /*if( $_GET["ruta"] == '"index.php?ruta=eliminar-costo-hp&idHp=" + idHp + "&idProyecto=" + idproyecto;'){
        echo'<script>
...
static public function mdlBorrarHp($tabla, $datos){
    ...
    swal({
          type: "success",
          title: "El costo hp ha sido borrado correctamente",
          ...
          confirmButtonText: "Aceptar"
                    ...
                    window.location = "costo-hp?idproyecto=' . $_GET["idProyecto"].'";
...
ModeloEliminarHp::mdlBorrarHp("hp",$_GET["idHp"]);
